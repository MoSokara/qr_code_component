...
- Solution URL: [qr code component solution](https://github.com/MoSokara/qr_code_component.git)
- Live Site URL: [Live Site](https://mosokara.github.io/qr_code_component/)
